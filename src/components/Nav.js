          ...
          <nav id="menu" className="menu">
            <div className="menu-navigation">
              <ul className="full-menu collapsible">
                ...
                <li><a href="shop.html" className="no-child">JCPlayer Store</a></li>
                <li><a href="news.html" className="no-child">JCPlayer News</a></li>
                <li><a href="video.html" className="no-child">JCPlayer Video</a></li>
                <li><a href="contact.html" className="no-child">JCPlayer Contact</a></li>
              </ul>
            </div>
          </nav>
